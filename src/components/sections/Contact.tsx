...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="space-y-12 mt-16 max-w-screen-2xl mx-auto p-4 sm:p-6 md:p-8"
    ...
    >
      ...
      <div className="relative">
        <div
          className={`text-center space-y-6 mb-7 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          <h2
            id="contact-title"
            className="text-4xl md:text-6xl font-black bg-gradient-to-r from-white via-cyan-200 to-teal-300 bg-clip-text text-transparent mb-4 leading-normal md:pb-2"
          >
            {t("contact_title")}
          </h2>
        ...
        <div
          className={`grid grid-cols-1 xl:grid-cols-2 gap-12 transition-all duration-1000 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div>
                ...
                <p id="message-help" className="text-gray-400 text-xs mt-1">
                  {t("contact_message_help")}
                </p>
              </div>
        ...
        <div
          className={`bg-gradient-to-r from-cyan-500/10 to-teal-500/10 backdrop-blur-sm rounded-lg p-8 border mt-12 border-cyan-400/20 transition-all duration-1000 delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
        ...
        <footer
          className={`text-center pt-8 border-t border-gray-700 transition-all duration-1000 delay-600 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
