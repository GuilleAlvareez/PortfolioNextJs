...
export default function About() {
  ...
  return (
    <div id="about-section" className="pt-20 px-6 relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-5 gap-12 items-start">
          ...
          <div className={`md:col-span-3 space-y-8 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
              <p>
                Mi aventura en el desarrollo web comenzó en el <strong className="font-semibold text-cyan-300">IES Hermanos Machado</strong>, 
                donde construí una base sólida en programación y las arquitecturas que dan vida a la web. 
                Esta formación fue el trampolín que me lanzó al mundo profesional.
              </p>
              <p>
                ...
                desarrollando plugins a medida para plataformas eLearning. Aprendí a transformar lo que el negocio necesita en soluciones técnicas que hacen más fácil y útil la experiencia para miles de usuarios
              </p>
              <p>
