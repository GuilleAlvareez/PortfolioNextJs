...
export default function Hero() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center text-center h-full min-h-screen pt-16 overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-black"/>
      
      {/* Bottom fade transition */}
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-gray-900 via-gray-900/50 to-transparent z-20"></div>
      
      {/* Animated Background Shapes */}
      {/* <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-r from-cyan-400/10 to-teal-400/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-teal-400/10 to-blue-400/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-cyan-300/5 to-teal-300/5 rounded-full blur-3xl animate-pulse delay-2000"></div>
      </div> */}
      ...
      {/* Main Content */}
      <div className={`relative z-10 space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500/10 to-teal-500/10 border border-cyan-400/20 rounded-full px-4 py-2 text-sm text-cyan-300 backdrop-blur-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center">
            <div className="h-1 w-32 bg-gradient-to-r from-cyan-400 to-teal-400 rounded-full"></div>
          </div>
        </div>
        ...
        <div className="space-y-6 max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed px-4">
            ...
            <span className="text-teal-300 font-semibold">NextJs</span> para optimizar rendimiento.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
          <a
            href="/CV.pdf" download="Guillermo Álvarez Moreno - CV.pdf"
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-600 to-teal-600 rounded-2xl blur opacity-0 group-hover:opacity-50 transition-all duration-300"></div>
          </a>
        ...
        <div className="flex justify-center gap-6 mt-8">
          <a href="https://www.linkedin.com/in/guillermo-%C3%A1lvarez-moreno-15904030a/" target='_blank' className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 hover:scale-110 transform">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
            </svg>
          </a>
          
          <a href="https://github.com/GuilleAlvareez" target='_blank' className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 hover:scale-110 transform">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
